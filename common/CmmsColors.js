...
const NAMED_COLORS = {
  ...
  //chat bg
  chatsContainerBg:'#e5ddd5',
  chatBg:'#e7ffdb',
  chatDone: '#2c9ec3',
  chatIconGreyColor: '#8999a1',
  ...
  //new
  joDone:"#7EC241",//4CB748
  joPending:"#959E21",
  joWip:"#D8BF00",

  logoTopGreen:'#7EC241',
  logoBottomGreen:'#4CB748',

  //tech home screen colors
  joGreenAlpha:'#26734d90',
  joYellowAlpha:'#cccc0090',
  joSilverAlpha:'#99999990',
  joSilver:'#999999',

  btnColorPositive:'#0066ff',
  ...
  yellowButton:"rgba(255,199,44,0.8)",
