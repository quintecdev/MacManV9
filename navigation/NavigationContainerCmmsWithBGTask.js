...
//     const User = JSON.parse(await AsyncStorage.getItem(ASK.ASK_USER));
//     console.log('user Details from the async storage==>>', User.TechnicianID);
//     try {
//       if (e == true) {
...
//   useEffect(() => {
//     console.log('time gap from the useEffect==>>', TimeGap);
...
//       );
//       console.log(
//         'emergency joblist count in with bg-->>',
//         EmergencyJoblistCount.data.BreakDown,
//       );
//       dispatch(
//         actionSetEmergencyJoblistNotificationCount(
...
//       })
//       .catch((err) => {
//         console.log('GetCutOffDate error-->>', {err});
//       });
//   }
...
//       })
//       .catch((err) => {
//         console.log('getMacManMobileAppTextData error-->>', {err});
