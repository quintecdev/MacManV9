...
<View style={{
                        flexDirection: 'row',alignItems:'center',
                            ...
                            <DatePicker
                                ...
                                customStyles={{
                                    ...
                                    dateText: {
                                        fontFamily:'san-serif-condensed',marginStart:16
                                    }
                                }}
    ...
    function fetchSparePartsList() {
        ...
        requestWithEndUrl(`${API_SUPERVISOR}SparepartsRequired`, { Date: selectedTimemillies, TypeOf: ScheduleStatus, NoOfDays: NoOfDays })
            .then((res) => {
                setSparepartsRequiredList([])
                if (res.status != 200)
