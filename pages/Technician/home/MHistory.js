...
export default MHistory = ({navigation, route: {params, name}}) => {
  ...
  useEffect(() => {
    ...
    requestWithEndUrl(`${API_TECHNICIAN}GetSixMonthMachineHistory`, {
        ...
        if (data.APKMachineHistoryJOList) {
          ...
          dispatch(
            actionSetAlertPopUpTwo({
              ...
              body: AppTextData.txt_No_data_found,
              visible: true,
              type: 'ok',
            }),
          );
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Icon
              name="chevron-up"
              size={22}
              color={pageIndex > 1 ? 'grey' : 'transparent'}
            />
          </TouchableOpacity>
          <CTextTitle
            style={{
          ...
          renderItem={({item}) => (
            <View
              ...
              <View
                ...
                <CTextTitle style={{color: 'black', fontSize: 15}}>
                  {item.JONO} ({item.MaintenanceType}) {item.FromDate} -{' '}
                  {item.ToDate}
              ...
              <View style={{marginStart: 5}}>
                <CmmsText style={{color: 'black', marginTop: 8}}>
                  <CmmsText style={{color: 'black', fontWeight: 'bold'}}>
