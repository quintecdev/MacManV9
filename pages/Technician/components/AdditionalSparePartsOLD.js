            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                if (additionalSparePartsDtls.length > 0) {
                  //check WH only if there any usedspare parts count is more than one
                  if (
                    additionalSparePartsDtls.filter(
                      (addSp) => addSp.WareHouseID == 0,
                    ).length > 0
                    ...
                    console.log('if condtion 2');
                    dispatch(
                      actionSetAlertPopUpTwo({
                        title: AppTextData.txt_Alert,
                        body: AppTextData.txt_Please_Update_Used_SpareParts_Count,
                        visible: true,
                        type: 'ok',
                      }),
                    );
                  } else {
                    console.log('if condtion 3');
                    if (params.isCheckList) {
                      console.log('if condtion 4');
                      params.updateSpareParts(additionalSparePartsDtls);
                    } else {
                      console.log('if condtion 5');
                      dispatch(
                        actionSetJobOrderReport({
                          ...JobOrderReportData,
